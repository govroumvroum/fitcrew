...
- Un créneau partagé en DUEL (deux plats proposés) reste en attente de la décision du foyer : signale-le, ne propose rien pour ce créneau tant qu'il n'est pas tranché. Même règle pour un créneau SÉPARÉ (le couple mange chacun son plat ce soir-là — un repas individuel sur un créneau partagé) : ne propose rien pour lui lors d'une régénération de jour, seule une génération de semaine complète re-propose un plat commun.
